...
def parse_args():
    ...
    parser.add_argument("--is_m3p", action='store_true', default=False,
                        help="Use M3P.")
    parser.add_argument("--config_file", default="config/vilbert_mini.json", type=str,
    ...
    parser.add_argument("--train_features_lmdbpath", default="/home/mareike/PycharmProjects/vqa_explanations/data/lmdb/val2014_small_boxes36.lmdb", type=str)
    # Training
